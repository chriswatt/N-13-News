...
$langmsg['personal'][14] = x("خيارات الافتراضي");
...
$langmsg['accounts'][26] = x("الملفات");
$langmsg['accounts'][27] = x("الصور");
...
$langmsg['filters'][7] = x("إضافة عامل تصفية جديد");
...
$langmsg['selectfield'][22] = x("حفظ ومتابعة");
...
$langmsg['js'][33] = x("هل أنت متأكد أنك تريد حذف مرشح مختارة (ق)؟");
