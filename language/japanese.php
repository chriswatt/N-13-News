...
$langmsg['options'][1] = x("新しい");
$langmsg['options'][2] = x("[編集]");
...
$langmsg['accounts'][26] = x("ファイル");
$langmsg['accounts'][27] = x("イメージズ");
...
$langmsg['filters'][7] = x("新しいフィルタを追加する");
...
$langmsg['js'][33] = x("あなたはあなたが）選択したフィルタを（sを削除しますか？");
