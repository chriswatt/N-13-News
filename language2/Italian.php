...
$langmsg['editnews'][25] = x("Filtra per categoria");
...
$langmsg['newsform'][22] = x("Articolo");
$langmsg['newsform'][23] = x("Inserisci l'URL di un'immagine");
$langmsg['newsform'][24] = x("Inserire");
$langmsg['newsform'][25] = x("Selezionare un'immagine caricata");
...
$langmsg['options'][1] = x("Nuovo");
$langmsg['options'][2] = x("Modifica");
...
$langmsg['accounts'][27] = x("Immagini");
...
$langmsg['filters'][7] = x("Aggiungere un nuovo filtro");
...
$langmsg['templates'][134] = x("Modulo di ricerca");
$langmsg['templates'][135] = x("Risultati della ricerca");
$langmsg['templates'][136] = x("File caricati");
$langmsg['templates'][137] = x("Importazione");
$langmsg['templates'][138] = x("Carica un modello esportato (s) file");
$langmsg['templates'][139] = x("Caricare");
$langmsg['templates'][140] = x("Incolla esportato modello (s)");
$langmsg['templates'][141] = x("Importazione");
$langmsg['templates'][142] = x("Template (s) importati");
$langmsg['templates'][143] = x("Nessun modello sono stati importati");
$langmsg['templates'][144] = x("Esportazione");
$langmsg['templates'][145] = x("Importare modelli.");
...
$langmsg['js'][33] = x("Sei sicuro di voler eliminare il filtro selezionato (s)?");
...
$langmsg['news'][50] = x("Inserisci il titolo di un articolo");
$langmsg['news'][51] = x("Riassunto");
$langmsg['news'][52] = x("Nessuna categoria");
$langmsg['news'][53] = x("Data");
$langmsg['news'][54] = x("Data di questo articolo è stato pubblicato");
$langmsg['news'][55] = x("Archivio");
